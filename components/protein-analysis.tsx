  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-gray-50 p-3 rounded-md">
          <h3 className="text-sm font-medium text-gray-700">Estimated Energy</h3>
          <p className="text-2xl font-bold text-indigo-700">{estimatedEnergy}</p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        <div>
          ...
          <Progress value={hydrophobicPercentage} className="h-2 bg-gray-200" indicatorClassName="bg-red-500" />
        </div>
        ...
        <div>
          ...
          <Progress value={polarPercentage} className="h-2 bg-gray-200" indicatorClassName="bg-blue-500" />
        </div>
      </div>

      <div className="bg-gray-50 p-3 rounded-md">
        <h3 className="text-sm font-medium text-gray-700 mb-2">Sequence Pattern</h3>
      ...
      <div>
        <h3 className="text-sm font-medium text-gray-700 mb-2">Hydrophobic Interactions</h3>
        <p className="text-sm text-gray-600">
          This protein has approximately {hydrophobicInteractions} hydrophobic interactions. In the HP model,
          hydrophobic interactions are the primary driving force for protein folding.
        </p>
      </div>
    </div>
  )
